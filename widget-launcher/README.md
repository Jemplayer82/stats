...
This package provides three native [Widget Launcher](https://github.com/chanallenk/widgetlauncher.extension) widgets:
...
- **System Monitor** combines CPU and RAM percentage dials with hard-drive throughput in MB/s and network throughput in Mb/s. Disk and network dials also show their read/write or download/upload breakdowns.
...
3. Refresh extensions, then add **Stats AI Usage**, **Apple Music Now Playing**, and/or **System Monitor**.
